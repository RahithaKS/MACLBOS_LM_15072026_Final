...
export default function SemanticSqlTest() {
  ...
  return (
    <div className="workspace-page h-full min-h-0 overflow-hidden bg-primary/10 p-6">
      <div className="workspace-surface h-full overflow-y-auto bg-white p-6 space-y-6">
